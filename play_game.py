...
def message_display(text, x, y, size):
    largeText = pygame.font.SysFont("microsoftjhengheimicrosoftjhengheiuilight", 20)
...
def button(text, x, y, w, h, light_color, color, action=None):
    ...
    smallText = pygame.font.SysFont("microsoftjhengheimicrosoftjhengheiuilight", 20)
...
def game_intro():
    while True:
        ...
        largeText = pygame.font.SysFont("microsoftjhengheimicrosoftjhengheiuilight", 50)
